...
class TestClass(
    ...
    fun getCodeLines(): MutableList<String> {
        ...
        lines.add("import shirates.core.configuration.Testrun")
        lines.add("import shirates.core.driver.branchextension.*")
        lines.add("import shirates.core.driver.commandextension.*")
        lines.add("import shirates.core.driver.function.*")
        lines.add("import shirates.core.testcode.*")
        lines.add("")
        lines.add("@SheetName(\"$sheetName\")")
        lines.add("class $testClassName : UITest() {")
