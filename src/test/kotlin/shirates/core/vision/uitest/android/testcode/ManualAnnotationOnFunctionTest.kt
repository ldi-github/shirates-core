...
class ManualAnnotationOnFunctionTest : VisionTest() {
...
//
//        assertThat(it.detect("8:30 AM").selector.toString()).isEqualTo("<8:30 AM>")
//        assertThat(
//            it.detect("8:30 AM").right(expression = "@Expand alarm").selector.toString()
//        ).isEqualTo("<8:30 AM>:right(@Expand alarm)")
//        assertThat(
//            it.detect("<8:30 AM>").right(expression = "#arrow&&@Expand alarm").selector.toString()
//        ).isEqualTo("<8:30 AM>:right(#arrow&&@Expand alarm)")
//        assertThat(it.detect("<8:30 AM>:below").below(2).selector.toString()).isEqualTo("<8:30 AM>:below(3)")
//        assertThat(it.detect("[8:30 AM]").selector.toString()).isEqualTo("[8:30 AM]")
//        assertThat(it.detect("[8:30 AM]:flow").selector.toString()).isEqualTo("[8:30 AM]:flow")
//        assertThat(it.detect("[8:30 AM]:flow").flow(1).selector.toString()).isEqualTo("[8:30 AM]:flow(2)")
//        assertThat(
//            it.detect("[8:30 AM]").below(1).select(":below(1)").selector.toString()
//        ).isEqualTo("[8:30 AM]:below(2)")
//        assertThat(
//            it.detect("[8:30 AM]")
//                .detect("[:Expand alarm]").selector.toString()
//        ).isEqualTo("[8:30 AM][:Expand alarm]")
//
//        run {
//            val sel = it.detect("[8:30 AM][:Expand alarm]").selector
