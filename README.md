...
Shirates/Vision is a Computer Vision(CV) driven mobile testing framework powered by Vision Framework on macOS.<br>

### True multi-platform

You can run tests on every application platform on Android/iOS because of CV driven.
...
The stability of Shirates/Vision has been improved on Android over the former versiono(Shirates/Classic).

### Shirates/Classic

[**Shirates/Classic**](doc/markdown/classic/index.md) is an older version of Shirates, previously simply **Shirates**.
