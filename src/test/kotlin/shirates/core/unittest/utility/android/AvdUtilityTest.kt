...
class AvdUtilityTest {
    ...
    fun getAvdDir() {
        ...
        // Act
        val actual = AvdUtility.getAvdDir()
        // Assert
        assertThat(actual).isEqualTo(UserVar.userHome.resolve(".android/avd").toString())
    }
    ...
    fun copy() {
        ...
        run {
            assertThatThrownBy {
                AvdUtility.copy("source", "new", "not exist avdDir")
            }.isInstanceOf(FileNotFoundException::class.java)
                .hasMessage("avdDir: not exist avdDir")
        }
        run {
