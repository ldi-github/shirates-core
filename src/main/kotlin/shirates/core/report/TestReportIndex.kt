...
"""
    ...
    private fun writeBody(sb: StringBuilder) {
        ...
        val elapsedSeconds = (updatedDate.time - createdDate.time) / 1000
        ...
        val acceleratedRate =
            if (elapsedSeconds == 0L) 0.0
            else totalLine.durationSeconds.toDouble() / elapsedSeconds
        val accelerated =
...
<body class='scroll' data-reload-timeout='$reloadTimeout'>
    <div class='main'>
        ...
        <br>
        Created at: <span id='created-at'>$createdAt</span> &nbsp;&nbsp; Updated at: <span id='updated-at'>$updatedAt</span> &nbsp;&nbsp; Elapsed: <span id='elapsed'>$elapsedSeconds</span>(sec)/<span id='elapsed-min'>$elapsedMinutes</span>(min) $accelerated
        <br>
