package shirates.core.uitest.android
        ...
        scenario {
            case(1) {
                condition {
                    ...
                    classicScope {
                        assertThat(it.javaClass.toString()).isEqualTo("class shirates.core.driver.TestElement")
                        ...
                        visionScope {
                            assertThat(it.javaClass.toString()).isEqualTo("class shirates.core.vision.VisionElement")
