...
1. パッケージディレクトリとして `src/test/kotlin/exercise`を作成します。

   ![](../_images/creating_package_1.png)<br><br>
   ![](../_images/creating_package_2.png)


2. kotlin class fileとして`TestClass1`を作成します。
...
**JUnit 5** (**org.junit.jupiter.api.Test**)の **@Test** アノテーションを付与します。
