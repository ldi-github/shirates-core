            ...
            case(1) {
                condition {
                    ...
                    assertThatThrownBy {
                        ...
                        .hasMessageStartingWith("[Notifications Screen] is displayed(screenName: [Android Settings Top Screen], isValid: true, recognizationMethod: classification, confidence: ")
                }
            }
            case(2) {
                expectation {
