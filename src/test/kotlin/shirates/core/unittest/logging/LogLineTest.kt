...
class LogLineTest : UnitTest() {
    ...
    fun getHeaderForConsole() {
        ...
        assertThat(header).isEqualTo("lineNo\t[elapsedTime]\tlogDateTime\t{testCaseId}\tmacroDepth\tmacroName\t[logType]\ttimeDiff\tmode\t(group)\tmessage")
    }
    ...
    fun getHeaderForCommandList() {
        ...
        assertThat(header).isEqualTo("lineNo\tlogDateTime\ttestCaseId\tmode\tlogType\tos\tspecial\tgroup\tlevel\tcommand\tmessage\tresult\texception")
    }
}